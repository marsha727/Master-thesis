...
lDay <- seq.Date(as.Date("2020-01-01","%Y-%m-%d"),as.Date("2023-06-06","%Y-%m-%d"),by = "1 day")
...
write.csv2(OWASIS_BBB, file = "Transformed/Langeweide_OWASIS_polder.csv", row.names = FALSE)


ggplot(OWASIS_BBB) + 
  geom_line(aes(x = day, y = BBB))
