...
#Next step would be to do Daniel van de Craats (WEnR) calculations of calibration curve
...
#calculating the AFPS (mm) using the max WFPS (%) measured
#converted by millimeter by calculating TPS = percentage of pores against pore volume
...
#For the loop to work i already make a new dataframe for AFPS in mm
