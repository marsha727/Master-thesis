...
Tensiometer_cmH20 <- Tensiometer_cmH20 %>% 
  ...
  mutate(MS_TMAP_5_D_030 = interpolated_WCS + ((interpolated_WCS - WCR1)/((1+abs(interpolated_a * MS_TMAP_5_D_040)^interpolated_n)^interpolated_m))) %>% 
  ...
  mutate(MS_TMAP_8_D_030 = interpolated_WCS + ((interpolated_WCS - WCR1)/((1+abs(interpolated_a * MS_TMAP_8_D_040)^interpolated_n)^interpolated_m))) %>% 
